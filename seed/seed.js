...
const lambos = await Promise.all([
    Lambo.create({
    id:1,
    model: 'Aventador S',
...
const models = await Promise.all([
  ...
  await Promise.all([
    ...
    lambos[1].addModel(models[0]),
    lambos[2].addModel(models[0]),
    lambos[3].addModel(models[0]),
    lambos[4].addModel(models[1]),
    lambos[5].addModel(models[1]),
    lambos[6].addModel(models[1]),
    lambos[7].addModel(models[1]),
    lambos[8].addModel(models[2]),
    lambos[9].addModel(models[2]),
    lambos[10].addModel(models[2]),
    lambos[11].addModel(models[3]),
    lambos[12].addModel(models[3]),
