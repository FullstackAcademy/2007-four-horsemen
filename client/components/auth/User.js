  ...
  render() {
    return (
      <div className='users-container'>
        <li>My Name: {this.props.user.name}</li>
        ...
        {this.props.user.isAdmin ? (
          <div className='user-bttns'>
            ...
            <Popup
              trigger={<button className='user-btn'> View All Orders</button>}
            ...
            <div className='user-bttn-div'>
            <Popup
              trigger={<button className='user-btn'> View All Users</button>}
              position="right center"
              modal
            >
            ...
            <div className='user-bttn-div'>
            <Popup
              trigger={<button className='user-btn'> Upload New Model!!</button>}
              position="right center"
              modal
            >
              {/* <AddProduct/> */}
          ...
          <Popup
            trigger={<button> View My Orders</button>}
            position="right center"
            modal
          >
